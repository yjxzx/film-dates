...
export function MovieCard({ movie }: { movie: Movie }) {
  ...
  return (
    <div className="border-print bg-newsprint">
      {/* Poster */}
      <div className="w-full aspect-[2/3] border-b border-dashed border-ink-faded flex items-center justify-center bg-ink/5 overflow-hidden">
        {movie.poster ? (
          <img
  ...
  <h3 className="text-[18px] font-bold text-ink leading-tight" style={{ fontFamily: "var(--font-newsprint-serif)" }}>
    {movie.title}
  </h3>
          <span className="border border-ink px-1.5 py-0.5 text-[16px] whitespace-nowrap shrink-0" style={{ fontFamily: "var(--font-newsprint-mono)" }}>
